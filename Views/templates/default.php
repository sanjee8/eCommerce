    ...
    <header>
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
            ...
            <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                <a class="me-3 py-2 text-dark text-decoration-none" href="#">Articles</a>
                <a class="me-3 py-2 text-dark text-decoration-none" href="#">Support</a>
                <a class="me-3 py-2 text-dark text-decoration-none" href="#">Se connecter/S'inscrire</a>
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li>
                        <a class="dropdown-item" href="#">
                            <div class="row">
                                <div class="col-3">
                                    <img width="50px" src="https://www.cdiscount.com/pdt2/0/2/2/1/300x300/samue65tu7022/rw/samsung-65tu7022-tv-led-4k-uhd-65-163-cm-h.jpg" alt="">
                                </div>
                                <div class="col-9">
                                    Nom d'article blabla
